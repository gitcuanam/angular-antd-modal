...
import { AppModalConfirmContainerComponent } from './modal-confirm-container.component';
...
@Injectable()
export class AppModalService implements OnDestroy {
  ...
  constructor(
    ...
    @Optional() @SkipSelf() private parentModal: AppModalService,
    ...
    const ContainerComponent =
      config.nzModalType === 'confirm'
        ? // If the mode is `confirm`, use `NzModalConfirmContainerComponent`
          AppModalConfirmContainerComponent
